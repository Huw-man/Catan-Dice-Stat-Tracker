...
class BarGraph:
    ...
    def __init__(self, parent):
        ...
        #each dictionary key holds an array containing the number, start position of the bar, roll times
        self.labels = {2:['2', labelGap, 0], 3:['3', 2*labelGap, 0], 4:['4', 3*labelGap, 0],
            5:['5', 4*labelGap, 0], 6:['6', 5*labelGap, 0], 7:['7', 6*labelGap, 0],
            8:['8', 7*labelGap, 0], 9:['9', 8*labelGap, 0], 10:['10', 9*labelGap, 0],
            11:['11', 10*labelGap, 0], 12:['12', 11*labelGap, 0]}
    ...
    def drawBars(self, canvas): #draw bars on graph
        ...
        for c in self.labels:
            canvas.create_rectangle(self.labels[c][1] -7, minHeight-(self.labels[c][2]*segmentHeight),
